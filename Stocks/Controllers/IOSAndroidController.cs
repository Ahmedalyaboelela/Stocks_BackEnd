...
namespace Stocks.Controllers
{
    public class IOSAndroidController : ControllerBase
    {
        ...
        public IActionResult PostPurchaseOrder([FromBody]JObject data)
        {
            string Code = data.GetValue("Code").ToString();
            int PayWay= Convert.ToInt32(data.GetValue("PayWay"));
            string PurchaseDate = data.GetValue("PurchaseDate").ToString();
            int EmployeeID= Convert.ToInt32(data.GetValue("EmployeeID"));
            string EmpNameAR = data.GetValue("EmpNameAR").ToString();
            string EmpNameEN = data.GetValue("EmpNameEN").ToString();
            string EmpCode = data.GetValue("EmpCode").ToString();
            int PortfolioID = Convert.ToInt32(data.GetValue("PortfolioID"));
            string PortfolioNameAR = data.GetValue("PortfolioNameAR").ToString();
            string PortfolioNameEN = data.GetValue("PortfolioNameEN").ToString();
            string PortfolioCode = data.GetValue("PortfolioCode").ToString();
            int PortfolioAccount = Convert.ToInt32(data.GetValue("PortfolioAccount"));
             var DetailsModels = data.GetValue("DetailsModels");
            
        
        PurchaseOrderModel purchaseOrderModel = new PurchaseOrderModel();
            purchaseOrderModel.Code = Code;
            purchaseOrderModel.EmpCode = EmpCode;
            purchaseOrderModel.EmpNameAR = EmpNameAR;
            purchaseOrderModel.EmpNameEN = EmpNameEN;
            purchaseOrderModel.PayWay = PayWay;
            purchaseOrderModel.PurchaseDate = PurchaseDate;
            purchaseOrderModel.PortfolioID = PortfolioID;
            purchaseOrderModel.PortfolioAccount = PortfolioAccount;
            purchaseOrderModel.PortfolioNameAR = PortfolioNameAR;
            purchaseOrderModel.PortfolioNameEN = PortfolioNameEN;
            purchaseOrderModel.PurchaseOrderID = 0;
            ...
            else
            {
                ...
                int portofolioaccount = purchaseOrderModel.PortfolioAccount;
        ...
        public IActionResult PostSellingOrder([FromBody]JObject data)
        {
            string Code = data.GetValue("Code").ToString();
            int PayWay = Convert.ToInt32(data.GetValue("PayWay"));
            string SellDate = data.GetValue("SellDate").ToString();
            int EmployeeID = Convert.ToInt32(data.GetValue("EmployeeID"));
            string EmpNameAR = data.GetValue("EmpNameAR").ToString();
            string EmpNameEN = data.GetValue("EmpNameEN").ToString();
            string EmpCode = data.GetValue("EmpCode").ToString();
            ...
            sellingOrderModel.Code = Code;
            sellingOrderModel.EmpCode = EmpCode;
            sellingOrderModel.EmpNameAR = EmpNameAR;
            sellingOrderModel.EmpNameEN = EmpNameEN;
            sellingOrderModel.PayWay = PayWay;
            sellingOrderModel.SellDate = SellDate;
            sellingOrderModel.PortfolioID = PortfolioID;
            sellingOrderModel.PortfolioAccount = PortfolioAccount;
            sellingOrderModel.PortfolioNameAR = PortfolioNameAR;
            sellingOrderModel.PortfolioNameEN = PortfolioNameEN;
            sellingOrderModel.SellingOrderID = 0;
            ...
            {
              int  portofolioaccount = sellingOrderModel.PortfolioAccount;
